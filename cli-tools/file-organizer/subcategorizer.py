...
RULES: dict[str, list[tuple[str, list[str]]]] = {
    ...
    "Documents": [
        ...
        ("Finance_Banking", ["bank", "statement", "salary", "hdfc", "nps", "credit_card",
                             ...
                             "pension", "annual_accounts", "client_wise"]),
        ...
        ("Immigration",     ["right_to_work", "evisa", "gwf", "ielts",
                             "biometric", "brp", "share_code", "rtw",
                             "checkinreceipt"]),
        ("Government_ID",   ["aadhaar", "pan_card", "passport", "driving", "voter",
                             "puc_parivahan"]),
        ("Work_Employment", ["offer_letter", "experience_letter",
                             "leave_of_absence", "appointment_slip",
                             "employment", "selected_students", "view_job"]),
        ...
        ("Books_Technical", ["system_design", "site_reliability", "serverless",
                             ...
                             "research_design", "google_scholar"]),
        ("Vehicle",         ["vehicle_details", "vehicle_tax", "puc_parivahan",
                             "scorpio", "insurance"]),
    ],
